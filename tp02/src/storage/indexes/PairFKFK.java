 ...
 */
public class PairFKFK implements RegisterTreeB<PairFKFK> {
   ...
   */
  @Override
  public PairFKFK clone() {
    return new PairFKFK(this.id, this.fk);
  }
   ...
   */
  public int compareTo(PairFKFK a) {
    System.out.println("Fk: " + this.fk);
